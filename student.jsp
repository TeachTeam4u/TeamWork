<%-- 
    Document   : student
    Created on : Dec 25, 2018, 2:01:24 AM
...
<div style="display:none;" id="myDiv" class="animate-bottom">
  <div name = "">  
      ...
      <!-- <div id = "student_name" style = "font-size:20px; color:white;">Welcome: <%= request.getAttribute("username") %></div> -->
      <div id = "student_name" style = "font-size:20px; color:white;">Welcome: <%= ck[0].getValue() %></div>
    ...
    <div id="templatemo_menu">
            ...
            <ul>
                <li><a href="ssub.jsp" class="current">Home</a></li>
                <li><a href="ssub.jsp">Take Quiz</a></li>
                <li><a href="#">Archive</a></li>
				<li><a href="record.html">See Your Record</a></li>
